...
カレンダー ID は GoogleCalendar の設定画面から取得することができます。（デフォルトでは[テスト](https://calendar.google.com/calendar/u/0?cid=a2UzN2Qxb2Jrb2E5aWhiamdobmM1MnVpNTRAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ)用のカレンダーに接続するように設定されています）
